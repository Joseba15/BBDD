...
-- Ejercicio 16:
SELECT  SUM(DP.CANTIDAD)*DP.PRECIO_UNIDAD,DP.CODIGO_PRODUCTO
FROM DETALLE_PEDIDO DP 
...
--Ejercicio 18:
SELECT PR.NOMBRE, P.TOTAL,SUM(DP.CANTIDAD),SUM(DP.CANTIDAD)*DP.PRECIO_UNIDAD, (SUM(DP.CANTIDAD)+DP.PRECIO_UNIDAD)*0,21
